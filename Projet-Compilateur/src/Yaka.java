 ...
 */
      ...
      simpleExpr();
                                ...
                                try {
                                        if (res==YakaConstants.tokenImage[ERROR])
                                                {if (true) throw new ParseException("type err");}
                                        else {
                                                String s = "" ;
                                                if (op==inf)            s = "\u005cniinf " ;
                                                if (op==infegal)        s = "\u005cniinfegal " ;
                                                if (op==sup)            s = "\u005cnisup " ;
                                                if (op==supegal)        s = "\u005cnisupegal " ;
                                                if (op==egal)           s = "\u005cniegal " ;
                                                if (op==diff)           s = "\u005cnidiff " ;

                                                if (s=="")
                                                        {if (true) throw new ParseException("operator err");}
                                                else
                                                        Yaka.result += s ;
                                        }
                                }
      ...
      primaire();
                                ...
                                try {
                                        if (res==YakaConstants.tokenImage[ERROR])
                                                ...
                                                String s = "" ;
                                                if (op==YakaConstants.tokenImage[MOINS])        s = "\u005cnineg " ;
                                                if (op==YakaConstants.tokenImage[NON])          s = "\u005cninot " ;
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x2,0x0,0x80000,0x28004,0x80000,0x0,0x100000,0x228004,0x228004,0x0,0x0,0x0,0x228004,0x228004,0x28004,0x0,0x0,0x0,0x0,};
   }
